<?php
	$name = "Ваня Кара";
	$addressContacts = '198 West 21th Street, Suite 721 New York NY 10016';
	$phoneContacts = '+ 1235 2355 98' ;
	$mailContacts = 'info@yoursite.com';
	$siteContacts = 'yoursite.com';
	$addresQuestions = '203 Fake St. Mountain View, San Francisco, California, USA';
	$phoneQuestions = '+2 392 3929 210' ;
	$siteQuestions = 'info@yourdomain.com';
?><!DOCTYPE html>
<html lang="en">
  <head>
